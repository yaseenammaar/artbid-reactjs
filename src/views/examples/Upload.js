                ...
                <Col lg="5">
                  <Card className="bg-secondary shadow border-0">
                    ...
                    <CardBody className="px-lg-5 py-lg-5">
                        <div className="text-muted text-center mb-1">
                            <input type="file" onChange={this.handleChange} className="custom-control-input"/>
                            <img src={this.state.featured}  />
                            <input type="file" onChange={this.handleFiveChange} className="custom-control-input"/>
                            <img src={this.state.five}  />
                          </div>
                      <Form role="form">
